...
days_from_now = 1  # 0 for today, 1 for tomorrow, 2 for the day after tomorrow, etc.
...
def trading_bot():
    ...
    while True:
        try:
            ...
            close_time_pht = now_pht.replace(hour=4, minute=29, second=0, microsecond=0) + timedelta(days=days_from_now)
