...
for kline in data:
    ...
    # **Trading Logic:**
    if pht_time.hour == 13 and pht_time.minute == 30 and current_position_data['stage'] == 0:  # 10 AM PHT
        
        current_position_data['lock_entry'] = False  # Unlock entry for new trades  
