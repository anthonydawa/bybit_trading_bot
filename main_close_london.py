...
markets = [
    {"symbol": "LINKUSDT", "qty": "4.3", "position": "short", "status": "open", "stop_loss": 23.646},
    {"symbol": "CRVUSDT", "qty": "93.3", "position": "short", "status": "open", "stop_loss": 1.1132},
    {"symbol": "FARTCOINUSDT", "qty": "67", "position": "short", "status": "open", "stop_loss": 1.5590},
    {"symbol": "UXLINKUSDT", "qty": "59", "position": "short", "status": "open", "stop_loss": 1.7570},
    {"symbol": "TROYUSDT", "qty": "22600", "position": "short", "status": "open", "stop_loss": 0.004547},
]
...
def trading_bot():
    ...
    while True:
        try:
            ...
            close_time_pht = now_pht.replace(hour=23, minute=50, second=0, microsecond=0) + timedelta(days=days_from_now)
