...
def get_qualified_markets2(sessions_to_check, check_rsi=True, check_trend=True, excluded_markets=None):
    """
    ...
    long_trades_file = os.path.join("buy_trades", "long_trades.csv")
    short_trades_file = os.path.join("sell_trades", "short_trades.csv")
